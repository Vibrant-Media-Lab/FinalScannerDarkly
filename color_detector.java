...
public class Controller {
    ...
    void configTab(){
        ...
        easySetLeftCamera.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                try{
                    ...
                    System.out.println("leftCamDirectory: "+leftCamDirectory);
                }
                catch (Exception e){
                    System.out.println("No directory selected.");
                }
        ...
        easySetRightCamera.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                try{
                    ...
                    System.out.println("rightCamDirectory: "+rightCamDirectory);
                }
                catch (Exception e){
                    System.out.println("No directory selected.");
                }
        ...
        easySetCameras.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent event) {
        		...
        		try {
        			...
        			String imagePath = testDirPath+"/"+contents[0];
        		    ...
        		    for (int y = 0; y < image1.getHeight(); y++) {
        		        for (int x = 0; x < image1.getWidth(); x++) {
        		          ...
        		          Color color = new Color(c);
        		           ...
        		           if (color.getRed() > 240 && color.getGreen() < 5 && color.getBlue() < 5) {
        		                isRed = true;
        		                break;
    ...
    void makeDirectories(){
        try {
            ...
            System.out.println("RIGHT: "+rightDir);
    ...
    void importFromCameras(){
        ...
        getColor(leftCamDirectory, rightCamDirectory);
    ...
    void getColor(File l, File r) {
        File tempLeft = leftCamDirectory;
        File tempRight = rightCamDirectory;
        
        System.out.println("original Left: "+tempLeft);
        
  
        String contents[] = l.list();
        System.out.println(contents[0]);
       // --

		System.out.println(l+"/"+contents[0]);	
		String imagePath = l+"/"+contents[0];
	    ...
	    /**    //  System.out.println("red: "+color.getRed());
	          if( color.getRed()>highestRed) {
	        	  highestRed = color.getRed();
	          } if(color.getBlue()>highestBlue) {
	        	  highestBlue = color.getBlue();
	          } if(color.getGreen()>highestGreen) {
	        	  highestGreen = color.getGreen();
	          }
	          if( color.getRed()<lowRed) {
	        	  lowRed = color.getRed();
	          } if(color.getBlue()<lowBlue) {
	        	  lowBlue = color.getBlue();
	          } if(color.getGreen()<lowGreen) {
	        	  lowGreen = color.getGreen();
	          }
	          **/
	         // System.out.println("green: "+color.getGreen());
	       //   System.out.println("blue: "+color.getBlue());
/**
 * red: 194 blue 189 green 195
low red: 0 blue 0 green 0

red: 142 blue 135 green 143
low red: 0 blue 0 green 0
 */
	           if (color.getRed() > 180 && color.getBlue() < color.getRed() && color.getBlue() < color.getRed()) {
	        	   System.out.println(color.getRGB() +" red found");
	                isRed = true;
	                break;
	        ...
	        if(isRed ==true) {
	        	leftCamDirectory = tempLeft;
	        	rightCamDirectory = tempRight;
	        	
	        }
	        else {
	        	leftCamDirectory = tempRight;
	        	rightCamDirectory = tempLeft;
	        	System.out.println("new Left: "+leftCamDirectory);
	        	System.out.println("new Right: "+rightCamDirectory);
	        }
